...
public struct BetterAuthURLHandler: ViewModifier {
    ...
    public init(authClient: BetterAuth, scheme: String) {
        self.authClient = authClient
        self.scheme = scheme
    }
        ...
        ZStack {
            content
                ...
                .onOpenURL { url in
                    ...
                    let _ = authClient.handleAuthCallback(url: url)
...
public extension View {
    func handleBetterAuthURL(authClient: BetterAuth, scheme: String) -> some View {
        modifier(BetterAuthURLHandler(authClient: authClient, scheme: scheme))
    }
}
